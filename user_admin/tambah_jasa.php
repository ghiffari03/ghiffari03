            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="daftar_jasa.php">Daftar jasa</a>
                        </li>
                        <li class="active">
                            <strong>Tambah jasa</strong>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1">Info jasa</a></li>
                            </ul>
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        <form action="aksi_tambah_jasa.php" enctype="multipart/form-data"
                                            method="POST">
                                            <fieldset class="form-horizontal">
                                                <div class="form-group"><label
                                                        class="col-sm-2 control-label">Nama:</label>
                                                    <div class="col-sm-10"><input type="text" class="form-control"
                                                            placeholder="Nama jasa" name="nama_jasa"></div>
                                                </div>
                                                <div class="form-group"><label
                                                        class="col-sm-2 control-label">Deskripsi:</label>
                                                    <div class="col-sm-10"><input type="text" class="form-control"
                                                            placeholder="deskripsi" name="deskripsi_jasa"></div>
                                                </div>
                                                <div class="form-group"><label
