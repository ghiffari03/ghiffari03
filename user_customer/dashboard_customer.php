        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <?php while ($dt_barang = $dt_query->fetch_array()) {
                    ...
                    $gambar_path = "../img/" . $dt_barang['gambar'];
                    ?>
                    <div class="col-md-3">
                        <div class="ibox">
                            <div class="ibox-content product-box">
                                ...
                                <div class="product-desc">
                                    ...
                                    <small class="text-muted"><?php echo $dt_barang['jenis']; ?></small>
                                    <a href="#modal-info-<?php echo $dt_barang['product_id']; ?>" data-toggle="modal"
                                        class="product-name">
                                    ...
                                    <form method="post" action="aksi_beli.php">
                                        <input type="hidden" name="product_id"
                                            value="<?php echo $dt_barang['id_barang']; ?>">
                                        <button type="submit" name="add_barang" class="btn btn-primary btn-sm m-t-xs"><i
